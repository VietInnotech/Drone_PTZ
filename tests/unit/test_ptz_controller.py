...
class TestPTZServiceInitialization:
    ...
    def test_initialization_success_with_valid_credentials(self, mock_onvif_camera):
    ...
    def test_initialization_with_config_defaults(self, mock_onvif_camera):
    ...
    def test_initialization_handles_connection_failure(self, mock_onvif_camera):
    ...
    def test_initialization_stores_ptz_ranges(self, mock_onvif_camera):
...
class TestPTZServiceRamp:
    ...
    @pytest.fixture
    def ptz_service(self, mock_onvif_camera):
